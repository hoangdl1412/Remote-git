...
if( !class_exists('Ftc_Blogs_Widget') ){
	class Ftc_Blogs_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'ftc-blogs-widget', 'description' => esc_html__('Display blogs on site', 'dove'));
			parent::__construct('ftc_blogs', esc_html__('FTC - Blogs', 'dove'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			$extra_class = '';
			$extra_class .= ($is_slider)?'ftc-slider loading owl-carousel':'';				
			?>
			<div class="ftc-blogs-wg <?php echo esc_attr($extra_class); ?>"<?php if($is_slider ){  ?> data-show_nav="<?php echo esc_attr($show_nav) ?>" data-auto_play="<?php echo esc_attr($auto_play) ?>"<?php } ?>>
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('orderby'); ?>"><?php esc_html_e('Order by', 'dove'); ?> </label>
			<select class="widefat" id="<?php echo $this->get_field_id('orderby'); ?>" name="<?php echo $this->get_field_name('orderby'); ?>">
				<option value="none" <?php selected('none', $instance['orderby']) ?>><?php esc_html_e('None', 'dove') ?></option>
				<option value="ID" <?php selected('ID', $instance['orderby']) ?>><?php esc_html_e('ID', 'dove') ?></option>
				<option value="title" <?php selected('title', $instance['orderby']) ?>><?php esc_html_e('Title', 'dove') ?></option>
				<option value="date" <?php selected('date', $instance['orderby']) ?>><?php esc_html_e('Date', 'dove') ?></option>
				<option value="comment_count" <?php selected('comment_count', $instance['orderby']) ?>><?php esc_html_e('Comment count', 'dove') ?></option>
				<option value="rand" <?php selected('rand', $instance['orderby']) ?>><?php esc_html_e('Random', 'dove') ?></option>
			</select>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id('order'); ?>"><?php esc_html_e('Order', 'dove'); ?> </label>
			<select class="widefat" id="<?php echo $this->get_field_id('order'); ?>" name="<?php echo $this->get_field_name('order'); ?>">
				<option value="asc" <?php selected('asc', $instance['order']) ?>><?php esc_html_e('Ascending', 'dove') ?></option>
				<option value="desc" <?php selected('desc', $instance['order']) ?>><?php esc_html_e('Descending', 'dove') ?></option>
			</select>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_thumbnail'); ?>"><?php esc_html_e('Show post thumbnail', 'dove'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_title'); ?>"><?php esc_html_e('Show post title', 'dove'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_date'); ?>"><?php esc_html_e('Show post date', 'dove'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_author'); ?>"><?php esc_html_e('Show post author', 'dove'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_comment'); ?>"><?php esc_html_e('Show post comment', 'dove'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_excerpt'); ?>"><?php esc_html_e('Show post excerpt', 'dove'); ?></label>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id('excerpt_words'); ?>"><?php esc_html_e('Number of words in excerpt', 'dove'); ?> </label>
