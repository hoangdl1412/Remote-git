...
if( !class_exists('Ftc_Products_Widget') ){
	class Ftc_Products_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'ftc-items-widget', 'description' => esc_html__('Display your products on site','dove'));
			parent::__construct('ftc_products', esc_html__('FTC - Products','dove'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			$columns    = ($instance['columns'] != 0)?absint($instance['columns']):1;
			$margin    = ($instance['margin'] != 0)?absint($instance['margin']):30;
			...
			if( $products->have_posts() ){
				...
				<div class="ftc-product-items-widget woocommerce <?php echo esc_attr($extra_class); ?>" <?php if($is_slider ){ ?> data-show_nav="<?php echo esc_attr($show_nav) ?>" data-columns="<?php echo esc_attr($columns) ?>" data-margin="<?php echo esc_attr($margin) ?>" data-auto_play="<?php echo esc_attr($auto_play) ?>"<?php } ?>>
			...
			function form( $instance ) {
				...
				?>
				<p>
					<label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Enter your title', 'dove'); ?> </label>
					<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
				</p>
				
				<p>
					<label for="<?php echo $this->get_field_id('product_type'); ?>"><?php esc_html_e('Product type', 'dove'); ?> </label>
					<select class="widefat" id="<?php echo $this->get_field_id('product_type'); ?>" name="<?php echo $this->get_field_name('product_type'); ?>">
						<option value="recent" <?php selected($instance['product_type'], 'recent'); ?>><?php esc_html_e('Recent', 'dove'); ?></option>
						<option value="sale" <?php selected($instance['product_type'], 'sale'); ?>><?php esc_html_e('Sale', 'dove'); ?></option>
						<option value="featured" <?php selected($instance['product_type'], 'featured'); ?>><?php esc_html_e('Featured', 'dove'); ?></option>
						<option value="best_selling" <?php selected($instance['product_type'], 'best_selling'); ?>><?php esc_html_e('Best selling', 'dove'); ?></option>
						<option value="top_rated" <?php selected($instance['product_type'], 'top_rated'); ?>><?php esc_html_e('Top rated', 'dove'); ?></option>
						<option value="mixed_order" <?php selected($instance['product_type'], 'mixed_order'); ?>><?php esc_html_e('Mixed order', 'dove'); ?></option>
					</select>
				</p>
				
				<p>
					<label><?php esc_html_e('Select categories', 'dove'); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('row'); ?>"><?php esc_html_e('Number of rows - in carousel slider', 'dove'); ?> </label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('columns'); ?>"><?php esc_html_e('Number of columns - in carousel slider', 'dove'); ?> </label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('margin'); ?>"><?php esc_html_e('Margin - in carousel slider', 'dove'); ?> </label>
					<input class="widefat" id="<?php echo $this->get_field_id('margin'); ?>" name="<?php echo $this->get_field_name('margin'); ?>" type="number" min="0" value="<?php echo esc_attr($instance['margin']); ?>" />
				</p>
				
				<p>
					<label for="<?php echo $this->get_field_id('limit'); ?>"><?php esc_html_e('Number of posts to show', 'dove'); ?> </label>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_thumbnail'); ?>"><?php esc_html_e('Show thumbnail', 'dove'); ?></label>
				</p>
				
				<p>
					<label for="<?php echo $this->get_field_id('thumbnail_size'); ?>"><?php esc_html_e('Thumbnail size', 'dove'); ?> </label>
					<select class="widefat" id="<?php echo $this->get_field_id('thumbnail_size'); ?>" name="<?php echo $this->get_field_name('thumbnail_size'); ?>">
						<option value="shop_thumbnail" <?php selected($instance['thumbnail_size'], 'shop_thumbnail'); ?>><?php esc_html_e('Product Thumbnails', 'dove'); ?></option>
						<option value="shop_catalog" <?php selected($instance['thumbnail_size'], 'shop_catalog'); ?>><?php esc_html_e('Catalog Images', 'dove'); ?></option>
						<option value="shop_single" <?php selected($instance['thumbnail_size'], 'shop_single'); ?>><?php esc_html_e('Single Product Image', 'dove'); ?></option>
					</select>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_categories'); ?>"><?php esc_html_e('Show categories', 'dove'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_product_title'); ?>"><?php esc_html_e('Show product title', 'dove'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_price'); ?>"><?php esc_html_e('Show price', 'dove'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_rating'); ?>"><?php esc_html_e('Show rating', 'dove'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('is_slider'); ?>"><?php esc_html_e('Show in a carousel slider', 'dove'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_nav'); ?>"><?php esc_html_e('Show navigation button', 'dove'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('auto_play'); ?>"><?php esc_html_e('Auto play', 'dove'); ?></label>
				</p>
