...
if( $related_posts->have_posts() ){
	...
	<div class="related-posts related <?php echo ($is_slider)?'loading':'' ?>">
		<header class="theme-title">
			<h3 class="title_sub"><span class="bg-heading"><span><?php esc_html_e('Related Posts', 'dove'); ?></span></span></h3>
		</header>
		<div class="meta-slider">
			<div class="blogs owl-carousel">
				...
				<div class="content-meta">
					<header>
						<!-- Blog Title -->
						<h3 class="loan title_sub blog-title entry-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
						<!-- Blog Date Time -->
						<?php if( $post_format != 'gallery' && $post_format !== false && $post_format != 'standard' ): ?>
					...
					<!-- Blog Excerpt -->
					<div class="entry-content"><?php ftc_the_excerpt_max_words(18, '', true, '', true); ?></div>
					
					<!-- Blog Author -->
					<!--<span class="author"><?php //esc_html_e('Post by ','dove') ?><?php //the_author_posts_link(); ?></span>-->
					
					<!-- Blog Read More -->
					<a href="<?php the_permalink(); ?>" class="button-readmore"><?php esc_html_e('Read More','dove') ?></a>
