<?php
add_action('widgets_init', 'vela_product_categories_load_widgets');

function vela_product_categories_load_widgets()
{
	register_widget('Vela_Product_Categories_Widget');
}

if(!class_exists('Vela_Product_Categories_Widget')){
	class Vela_Product_Categories_Widget extends WP_Widget {

		function __construct() {
			$widgetOps = array('classname' => 'vela-product-categories-widget', 'description' => esc_html__('Display Your Product Categories', 'bagstore'));
			parent::__construct('vela_product_categories', esc_html__('Vela - Product Categories', 'bagstore'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			<div class="vela-product-categories-item vela-product-categories-widget">
				<?php 
					$args = array(
...
//							}
		...
		function form( $instance ) { 
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_post_count'); ?>"><?php esc_html_e('Show post count', 'bagstore'); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_sub_cat'); ?>"><?php esc_html_e('Show sub categories', 'bagstore'); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('hide_empty'); ?>"><?php esc_html_e('Hide empty categories', 'bagstore'); ?></label>
			</p>
			<p>
				...
				<span class="description"><?php esc_html_e("Don't select to show all", "bagstore"); ?></span>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('orderby'); ?>"><?php esc_html_e('Order by', 'bagstore'); ?></label>
				<select class="widefat" id="<?php echo $this->get_field_id('orderby'); ?>" name="<?php echo $this->get_field_name('orderby'); ?>" >
					<option value="name" <?php selected($instance['orderby'], 'name'); ?> ><?php esc_html_e('Name', 'bagstore'); ?></option>
					<option value="slug" <?php selected($instance['orderby'], 'slug'); ?> ><?php esc_html_e('Slug', 'bagstore'); ?></option>
					<option value="count" <?php selected($instance['orderby'], 'count'); ?> ><?php esc_html_e('Number product', 'bagstore'); ?></option>
					<option value="rand" <?php selected($instance['orderby'], 'rand'); ?> ><?php esc_html_e('Random', 'bagstore'); ?></option>
					<option value="none" <?php selected($instance['orderby'], 'none'); ?> ><?php esc_html_e('None', 'bagstore'); ?></option>
				</select>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('order'); ?>"><?php esc_html_e('Order', 'bagstore'); ?></label>
				<select class="widefat" id="<?php echo $this->get_field_id('order'); ?>" name="<?php echo $this->get_field_name('order'); ?>" >
					<option value="asc" <?php selected($instance['order'], 'asc'); ?> ><?php esc_html_e('Ascending', 'bagstore'); ?></option>
					<option value="desc" <?php selected($instance['order'], 'desc'); ?> ><?php esc_html_e('Descending', 'bagstore'); ?></option>
				</select>
			</p>
