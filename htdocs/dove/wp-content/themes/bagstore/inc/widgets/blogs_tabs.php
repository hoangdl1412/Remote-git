<?php
add_action('widgets_init', 'vela_blogs_tabs_load_widgets');

function vela_blogs_tabs_load_widgets()
{
	register_widget('Vela_Blogs_Tabs_Widget');
}

if( !class_exists('Vela_Blogs_Tabs_Widget') ){
	class Vela_Blogs_Tabs_Widget extends WP_Widget {

		function __construct() {
			$widgetOps = array('classname' => 'vela-blogs-tabs-widget', 'description' => esc_html__('Display popular and recent blogs in tabs', 'bagstore'));
			parent::__construct('vela_blogs_tabs', esc_html__('Vela - Blogs Tabs', 'bagstore'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			$args = array(
					...
					,'meta_key'				=> '_vela_post_views_count'
			...
			$shortcode_html = '';
			$shortcode_html .= '[vc_tta_tabs vela_style="top_border"]';
			$shortcode_html .= '[vc_tta_section title="'.$popular_title.'" tab_id="vela-popular-tab-'.rand().'"]'.$popular_tab_content.'[/vc_tta_section]';
			$shortcode_html .= '[vc_tta_section title="'.$recent_title.'" tab_id="vela-recent-tab-'.rand().'"]'.$recent_tab_content.'[/vc_tta_section]';
		...
		?>
			<p>
				<label for="<?php echo $this->get_field_id('popular_title'); ?>"><?php esc_html_e('Popular tab title', 'bagstore'); ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('recent_title'); ?>"><?php esc_html_e('Recent tab title', 'bagstore'); ?> </label>
