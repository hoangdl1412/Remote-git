<?php
add_action('widgets_init', 'vela_blogs_load_widgets');

function vela_blogs_load_widgets()
{
	register_widget('Vela_Blogs_Widget');
}

if( !class_exists('Vela_Blogs_Widget') ){
	class Vela_Blogs_Widget extends WP_Widget {

		function __construct() {
			$widgetOps = array('classname' => 'vela-blogs-widget', 'description' => esc_html__('Display blogs on site', 'bagstore'));
			parent::__construct('vela_blogs', esc_html__('Vela - Blogs', 'bagstore'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			if( $posts->have_posts() ):
				...
				$extra_class = '';
				$extra_class .= ($is_slider)?'vela-slider loading owl-carousel':'';				
				?>
                                <div class="vela-blogs-wg <?php echo esc_attr($extra_class); ?>"<?php if($is_slider ){  ?> data-show_nav="<?php echo esc_attr($show_nav) ?>" data-auto_play="<?php echo esc_attr($auto_play) ?>"<?php } ?>>
						...
						<?php endif; ?>
							<li>
								...
								<?php if( $post_format != 'quote' ): ?>
									...
									<?php if( $show_excerpt ): ?>
										<div class="meta">
											<?php vela_the_excerpt_max_words($excerpt_words, $post); ?>
										</div>
									<?php endif; ?>
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('orderby'); ?>"><?php esc_html_e('Order by', 'bagstore'); ?> </label>
				<select class="widefat" id="<?php echo $this->get_field_id('orderby'); ?>" name="<?php echo $this->get_field_name('orderby'); ?>">
					<option value="none" <?php selected('none', $instance['orderby']) ?>><?php esc_html_e('None', 'bagstore') ?></option>
					<option value="ID" <?php selected('ID', $instance['orderby']) ?>><?php esc_html_e('ID', 'bagstore') ?></option>
					<option value="title" <?php selected('title', $instance['orderby']) ?>><?php esc_html_e('Title', 'bagstore') ?></option>
					<option value="date" <?php selected('date', $instance['orderby']) ?>><?php esc_html_e('Date', 'bagstore') ?></option>
					<option value="comment_count" <?php selected('comment_count', $instance['orderby']) ?>><?php esc_html_e('Comment count', 'bagstore') ?></option>
					<option value="rand" <?php selected('rand', $instance['orderby']) ?>><?php esc_html_e('Random', 'bagstore') ?></option>
				</select>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id('order'); ?>"><?php esc_html_e('Order', 'bagstore'); ?> </label>
				<select class="widefat" id="<?php echo $this->get_field_id('order'); ?>" name="<?php echo $this->get_field_name('order'); ?>">
					<option value="asc" <?php selected('asc', $instance['order']) ?>><?php esc_html_e('Ascending', 'bagstore') ?></option>
					<option value="desc" <?php selected('desc', $instance['order']) ?>><?php esc_html_e('Descending', 'bagstore') ?></option>
				</select>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_thumbnail'); ?>"><?php esc_html_e('Show post thumbnail', 'bagstore'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_title'); ?>"><?php esc_html_e('Show post title', 'bagstore'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_date'); ?>"><?php esc_html_e('Show post date', 'bagstore'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_author'); ?>"><?php esc_html_e('Show post author', 'bagstore'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_comment'); ?>"><?php esc_html_e('Show post comment', 'bagstore'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_excerpt'); ?>"><?php esc_html_e('Show post excerpt', 'bagstore'); ?></label>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id('excerpt_words'); ?>"><?php esc_html_e('Number of words in excerpt', 'bagstore'); ?> </label>
