...
class Vela_Custom_Product_Category{
	...
	function add_category_fields(){
		...
		?>
		<div class="form-field vela-product-cat-upload-field">
			<label><?php esc_html_e( 'Breadcrumbs Background Image', 'bagstore' ); ?></label>
			...
			<div class="button-wrapper">
				...
				<button type="button" class="button upload-button"><?php esc_html_e('Upload/Add image', 'bagstore') ?></button>
				<button type="button" class="button remove-button"><?php esc_html_e('Remove image', 'bagstore') ?></button>
			</div>
		</div>
		
		<div class="form-field">
			<label for="layout"><?php esc_html_e( 'Layout', 'bagstore' ); ?></label>
			<select name="layout" id="layout">
				<option value=""><?php esc_html_e('Default', 'bagstore') ?></option>
				<option value="0-1-0"><?php esc_html_e('Fullwidth', 'bagstore') ?></option>
				<option value="1-1-0"><?php esc_html_e('Left Sidebar', 'bagstore') ?></option>
				<option value="0-1-1"><?php esc_html_e('Right Sidebar', 'bagstore') ?></option>
				<option value="1-1-1"><?php esc_html_e('Left & Right Sidebar', 'bagstore') ?></option>
			</select>
		</div>
		
		<div class="form-field">
			<label for="left_sidebar"><?php esc_html_e( 'Left Sidebar', 'bagstore' ); ?></label>
		...
		<div class="form-field">
			<label for="right_sidebar"><?php esc_html_e( 'Right Sidebar', 'bagstore' ); ?></label>
		...
		<div class="form-field vela-product-cat-upload-field">
			<label><?php esc_html_e( 'Banner', 'bagstore' ); ?></label>
			<div class="preview-image">
				<?php echo wc_placeholder_img( 'thumbnail' ); ?>
			</div>
			<div class="button-wrapper">
		...
		<div class="form-field vela-product-cat-upload-field">
			<label><?php esc_html_e( 'Icon', 'bagstore' ); ?></label>
			<div class="preview-image">
				<?php echo wc_placeholder_img( 'thumbnail' ); ?>
			</div>
			<div class="button-wrapper">
		...
		<div class="form-field">
			<label><?php esc_html_e( 'Top border color', 'bagstore' ); ?></label>
			<input type="text" name="product_cat_shortcode_border_top_color" class="vela-color-picker" value="" data-default-color=""/>
		</div>
		<?php
	}
	...
	function edit_category_fields( $term, $taxonomy ){
		...
		?>
		<tr class="form-field vela-product-cat-upload-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Breadcrumbs Background Image', 'bagstore' ); ?></label></th>
			<td>
				<div class="preview-image">
					<?php 
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Layout', 'bagstore' ); ?></label></th>
			<td>
				<select name="layout" id="layout">
					<option value="" <?php selected($layout, ''); ?>><?php esc_html_e('Default', 'bagstore') ?></option>
					<option value="0-1-0" <?php selected($layout, '0-1-0'); ?>><?php esc_html_e('Fullwidth', 'bagstore') ?></option>
					<option value="1-1-0" <?php selected($layout, '1-1-0'); ?>><?php esc_html_e('Left Sidebar', 'bagstore') ?></option>
					<option value="0-1-1" <?php selected($layout, '0-1-1'); ?>><?php esc_html_e('Right Sidebar', 'bagstore') ?></option>
					<option value="1-1-1" <?php selected($layout, '1-1-1'); ?>><?php esc_html_e('Left & Right Sidebar', 'bagstore') ?></option>
				</select>
			</td>
		</tr>
		
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Left Sidebar', 'bagstore' ); ?></label></th>
			<td>
				<select name="left_sidebar" id="left_sidebar">
					<option value="" <?php selected($left_sidebar, ''); ?>><?php esc_html_e('Default', 'bagstore') ?></option>
					<?php foreach( $sidebar_options as $sidebar_id => $sidebar_name ): ?>
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Right Sidebar', 'bagstore' ); ?></label></th>
			<td>
				<select name="right_sidebar" id="right_sidebar">
					<option value="" <?php selected($right_sidebar, ''); ?>><?php esc_html_e('Default', 'bagstore') ?></option>
					<?php foreach( $sidebar_options as $sidebar_id => $sidebar_name ): ?>
		...
		<tr class="form-field vela-product-cat-upload-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Banner', 'bagstore' ); ?></label></th>
			<td>
				<div class="preview-image">
					<?php
		...
		<tr class="form-field vela-product-cat-upload-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Icon', 'bagstore' ); ?></label></th>
			<td>
				<div class="preview-image">
					<?php
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Top border color', 'bagstore' ); ?></label></th>
			<td><input type="text" name="product_cat_shortcode_border_top_color" class="vela-color-picker" value="<?php echo esc_attr($shortcode_border_top_color) ?>" data-default-color="<?php echo esc_attr($shortcode_border_top_color) ?>"/></td>
		</tr>
		<?php
	}
...
new Vela_Custom_Product_Category();
?>