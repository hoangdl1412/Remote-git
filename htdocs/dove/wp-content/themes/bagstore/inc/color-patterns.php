 ...
 */
function vela_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter bagstore default saturation level.
	 *
	 * @since bagstore 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'vela_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.vela-front-page) .entry-title,
...
.colors-custom .vela-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.vela-front-page .panel-content .recent-posts article,
...
.colors-custom.vela-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters bagstore custom colors CSS.
	 *
	 * @since bagstore 1.0
	 *
	 ...
	 */
	return apply_filters( 'vela_custom_colors_css', $css, $hue, $saturation );
}
