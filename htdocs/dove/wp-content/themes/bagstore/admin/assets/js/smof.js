...
jQuery(document).ready(function($){
	...
	function stickyInfo() {
        ...
        if (!jQuery('#info_bar').isOnScreen() && !jQuery('#vela-footer-theme-options-sticky').isOnScreen()) {
            jQuery('#vela-footer-theme-options').css({
                position: 'fixed'
                ,bottom: '0'
                ,width: stickyWidth
            ...
            jQuery('#vela-footer-theme-options').addClass('sticky-footer-fixed');
        } else {
            jQuery('#vela-footer-theme-options').css({
                background: ''
                ,position: 'inherit'
            ...
            jQuery('#vela-footer-theme-options').removeClass('sticky-footer-fixed');
        }
    }

    if (jQuery('#vela-footer-theme-options').length !== 0) {
	...
	var current_color_scheme = $('input[name="vela_color_scheme"]').siblings('img.of-radio-img-selected').siblings('input[name="vela_color_scheme"]').val();
	$('input[name="vela_color_scheme"]').siblings('img').bind('click', function(){
		var input = $(this).siblings('input[name="vela_color_scheme"]');
		...
		if( ok ){
			...
			$('input[name="vela_color_scheme"][value="'+current_color_scheme+'"]').siblings('img').trigger('click');
		}
	});
