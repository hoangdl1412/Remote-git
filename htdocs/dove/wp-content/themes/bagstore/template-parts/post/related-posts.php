...
?>
	<div class="related-posts related <?php echo ($is_slider)?'loading':'' ?>">
		<header class="theme-title">
                    <h3 class="title_sub"><span class="bg-heading"><span><?php esc_html_e('Related Posts', 'vela'); ?></span></span></h3>
		</header>
			...
			<div class="blogs owl-carousel">
				...
				<article>
						...
						if( $post_format == 'audio' ){
							...
							if( strlen($audio_url) > 4 ){
								...
								if( in_array($file_format, array('mp3', 'ogg', 'wav')) ){
									...
									echo do_shortcode('[vela_soundcloud url="'.esc_url($audio_url).'" width="100%" height="166"]');
								}
							}
						}
						?>
					...
					<div class="content-meta">
						...
						<!-- Blog Excerpt -->
						<div class="entry-content"><?php vela_the_excerpt_max_words(18, '', true, '', true); ?></div>
						
						<!-- Blog Author -->
						<!--<span class="author"><?php //esc_html_e('Post by ','vela') ?><?php //the_author_posts_link(); ?></span>-->
						
						<!-- Blog Read More -->
						<a href="<?php the_permalink(); ?>" class="button-readmore"><?php esc_html_e('Read More','vela') ?></a>
