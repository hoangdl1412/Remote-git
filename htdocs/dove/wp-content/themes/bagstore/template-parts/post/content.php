...
<article <?php post_class($post_class) ?>>
	...
	<?php if( $post_format != 'quote' ): ?>
		...
		<div class="entry-content">
			...
			<div class="entry-info">
				...
				if ( ($categories_list && $smof_data['vela_cavela-link']) || $smof_data['vela_blog_author'] ): 
			?>
			<div class="entry-bottom">
				<!-- Blog Categories -->
				<?php if ( $categories_list && $smof_data['vela_cavela-link'] ): ?>
				<div class="cavela-link">
					<span><?php esc_html_e('Categories: ', 'bagstore'); ?></span>
				...
				<span class="vcard author"><?php esc_html_e('Post by ', 'bagstore'); ?><?php the_author_posts_link(); ?></span>
				<?php endif; ?>			
			</div>
			<?php endif; ?>
	...
	<?php endif; ?>
				...
				<div class="entry-summary">
					...
					<?php if( $smof_data['vela_blog_read_more'] ): ?>
					<a class="button-readmore" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read More', 'bagstore'); ?></a>
					<?php endif; ?>
