...
<div class="details-img">
	...
	<?php
		...
		do_action('vela_before_product_image');
		...
		if ( has_post_thumbnail() ) {
			...
			echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<img src="%s" alt="%s" />', wc_placeholder_img_src(), esc_html__( 'Placeholder', 'bagstore' ) ), $post->ID );
