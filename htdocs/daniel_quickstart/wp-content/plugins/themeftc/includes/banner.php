		...
		?>
			...
			<p>
				...
				<select class="widefat" name="<?php echo $this->get_field_name('style_effect'); ?>" id="<?php echo $this->get_field_id('style_effect'); ?>">
					<option value="background-scale" <?php selected('background-scale', $instance['style_effect']) ?>><?php esc_html_e('Background Scale', 'themeftc') ?></option>
					<option value="background-scale-opacity" <?php selected('background-scale-opacity', $instance['style_effect']) ?>><?php esc_html_e('Background Scale Opacity', 'themeftc') ?></option>
					<option value="background-scale-and-line" <?php selected('background-scale-and-line', $instance['style_effect']) ?>><?php esc_html_e('Background Scale And Line', 'themeftc') ?></option>
					<option value="background-scale-opacity-line" <?php selected('background-scale-opacity-line', $instance['style_effect']) ?>><?php esc_html_e('Background Scale Opacity Line', 'themeftc') ?></option>
