	...
	class Ftc_Product_Deals_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			if( $products->have_posts() ){
				...
				<div class="ftc-product-deals-widget-wrapper ftc-product-deals-slider-wrapper woocommerce columns-1 <?php echo esc_attr($extra_class); ?>" id="<?php echo esc_attr($rand_id); ?>">
