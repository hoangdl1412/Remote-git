    ...
    <div class="post-img">
		...
		<div class="post-info">
			...
			<div class="entry-info">
				...
				<h3 class="blog_title entry-title">
					<a class="post-title blog_title" href="<?php the_permalink() ; ?>"><?php the_title(); ?></a>
                                        <?php if ( is_sticky() && is_home() && ! is_paged() ): {
						printf( '<span class="sticky-post">%s</span>', __( 'Featured', 'daniel' ) );
					}?>
					<?php endif; ?>
				...
				<?php endif; ?>
                                <!-- Blog Tags -->
                                    ...
                                    <span class="tags-link">
                                            <span><?php esc_html_e('Tags: ','daniel');?></span>
			...
			<?php endif; ?>
				...
				<div class="entry-summary">
					...
					<a class="button-readmore" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read More', 'daniel'); ?></a>
					<?php endif; ?>
				</div>
			</div>
