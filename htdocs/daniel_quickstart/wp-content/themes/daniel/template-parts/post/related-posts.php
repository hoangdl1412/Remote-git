...
?>
	<div class="related-posts related <?php echo ($is_slider)?'loading':'' ?>">
		<header class="theme-title">
                    <h3 class="blog_title"><span class="bg-heading"><span><?php esc_html_e('Related Posts', 'daniel'); ?></span></span></h3>
		</header>
				...
				<article>
					...
					<div class="post-info">
						<header class="entry-header">
							<!-- Blog Title -->
							<h3 class="blog_title entry-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                                                        ...
                                                        <span class="vcard author"><?php esc_html_e('Post by: ', 'daniel'); ?><?php the_author_posts_link(); ?></span>
                                                        <?php endif; ?>	
                                                        <!-- Blog Categories -->
                                                        <?php if ( $categories_list && $smof_data['ftc_blog_categories'] ): ?>
                                                        <div class="caftc-link">
                                                            <span><?php esc_html_e('Categories: ', 'daniel'); ?></span>
						...
						<!-- Blog Author -->
						<!--<span class="author"><?php //esc_html_e('Post by ','daniel') ?><?php //the_author_posts_link(); ?></span>-->
						
						<!-- Blog Read More -->
						<a href="<?php the_permalink(); ?>" class="button-readmore"><?php esc_html_e('Read More','daniel') ?></a>
					</div>
				</article>
				<?php endwhile; ?>
			</div>
