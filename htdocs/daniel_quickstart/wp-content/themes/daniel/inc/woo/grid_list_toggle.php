...
if( !class_exists('Ftc_Grid_List') && ftc_has_woocommerce() ){
	class Ftc_Grid_List{
		function __construct(){
			...
			$this->settings = array(
				array(
					'name' => esc_html__( 'Default catalog view', 'daniel' ),
					'type' => 'title',
					'id' => 'ftc_glt_options'
				),
				array(
					'name' 		=> esc_html__( 'Catalog view', 'daniel' ),
					'desc_tip' 	=> '',
					'id' 		=> 'ftc_enable_glt',
					'type' 		=> 'checkbox',
					'desc' 		=> esc_html__('Display option to show product in grid or list view', 'daniel'),
					'default' 	=> 'yes'
				),
				array(
					'name' 		=> esc_html__( 'Default catalog view', 'daniel' ),
					'desc_tip' 	=> esc_html__( 'Display products in grid or list view by default', 'daniel' ),
					'id' 		=> 'ftc_glt_default',
					'type' 		=> 'select',
					'options' 	=> array(
						'grid'  => esc_html__('Grid', 'daniel'),
						'list' 	=> esc_html__('List', 'daniel')
					)
				),
		...
		function gridlist_toggle_button() {
			?>
				<nav class="gridlist-toggle">
					<a href="#" id="grid" title="<?php esc_html_e('Grid view', 'daniel'); ?>">&#8862; <span><?php esc_html_e('Grid view', 'daniel'); ?></span></a><a href="#" id="list" title="<?php esc_html_e('List view', 'daniel'); ?>">&#8863; <span><?php esc_html_e('List view', 'daniel'); ?></span></a>
				</nav>
			<?php
		}
