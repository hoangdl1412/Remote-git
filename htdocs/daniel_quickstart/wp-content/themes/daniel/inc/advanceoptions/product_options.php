...
$options[] = array(
				...
				,'label'	=> esc_html__('Product Layout', 'daniel')
				,'desc'		=> ''
				,'type'		=> 'heading'
			);
...
$options[] = array(
				...
				,'label'	=> esc_html__('Custom Tab', 'daniel')
				,'desc'		=> ''
				,'type'		=> 'heading'
			);
...
$options[] = array(
				...
				,'options'	=> array(
									'0'		=> esc_html__('Default', 'daniel')
									,'1'	=> esc_html__('Override', 'daniel')
								)
			);
			
$options[] = array(
				'id'		=> 'prod_custom_tab_title'
				,'label'	=> esc_html__('Custom Tab Title', 'daniel')
				,'desc'		=> ''
				,'type'		=> 'text'
			);
...
$options[] = array(
				...
				,'label'	=> esc_html__('Custom Tab Content', 'daniel')
				,'desc'		=> ''
				,'type'		=> 'textarea'
			);
...
$options[] = array(
				...
				,'label'	=> esc_html__('Breadcrumbs', 'daniel')
				,'desc'		=> ''
				,'type'		=> 'heading'
			);
