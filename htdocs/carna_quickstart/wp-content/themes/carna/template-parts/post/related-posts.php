...
?>
	<div class="related-posts related <?php echo ($is_slider)?'loading':'' ?>">
		<header class="related-post-title">
                    <h3 class="product_title"><span class="bg-heading"><span><?php esc_html_e('Related Posts', 'carna'); ?></span></span></h3>
		</header>
					...
					<div class="post-info">
						<header class="entry-header">
							...
							<h3 class="product_title blog-title entry-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                                                        ...
                                                        <span class="vcard author"><?php esc_html_e('Post by: ', 'carna'); ?><?php the_author_posts_link(); ?></span>
                                                        <?php endif; ?>	
                                                        <!-- Blog Categories -->
						...
						<!-- Blog Author -->
						<!--<span class="author"><?php //esc_html_e('Post by ','carna') ?><?php //the_author_posts_link(); ?></span>-->
						
						<!-- Blog Read More -->
						<a href="<?php the_permalink(); ?>" class="button-readmore"><?php esc_html_e('Read More','carna') ?></a>
					</div>
				</article>
				<?php endwhile; ?>
			</div>
